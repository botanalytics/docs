...
| Name        				| Required				| Default      							| Description
| ----------- 				| ------------ 			| ------------ 							| -----
| `botanalytics.baseUrl`    | No						| `https://api.botanalytics.co/v2`           | Base URL to be used for sending requests. Do not change this unless instructed by the Botanalytics team.
