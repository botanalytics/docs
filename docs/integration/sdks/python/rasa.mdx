...
This section describes how to integrate a Rasa with Botanalytics.
...
| -------- 				| ------------ 			| ------- 				| ------	    | -----
| `apiKey`    | Yes						| `Has no default`          |  API key that is provided when a Rasa channel is added to a project. | ```BA_API_KEY```
