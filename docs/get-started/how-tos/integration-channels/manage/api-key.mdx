...
import ProjectListChannels from '@site/static/img/projects/rasa-added-list.png';
import IntegrationChannelSelect from '@site/static/img/projects/integration-channel-select.png';
import ChannelRegenerate from '@site/static/img/projects/integration-channel-regenerate.png';
...
<img src={ProjectSettingsChannelsTab} alt="Project Settings Channels" />

<img src={ProjectListChannels} alt="Project List Channels" />
...
<img src={IntegrationChannelSelect} alt="Project Settings Channel Select" />
...
<img src={ChannelRegenerate} alt="Project Settings Integration Channel Regenerate" />
