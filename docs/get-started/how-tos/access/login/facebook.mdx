...
import LoginOptionsFacebook from '@site/static/img/signup/login-options-facebook.png';
import LoginWithFacebook from '@site/static/img/signup/signup-with-facebook-login.png';
...
- On the login page, select the "Login with Facebook" option.
  <img src={LoginOptionsFacebook} alt="Login Options Facebook" />
...
- If you're not currently logged into your Facebook account, a new pop-up window will appear. In the pop-up window, enter your Facebook email or phone number and password and Click "Log In."
  <img src={LoginWithFacebook} alt="Login To Your Facebook Account" />
