...
import ChannelAddedApiKey from '@site/static/img/projects/show-api-token.png';
import ChannelCopyApiKey from '@site/static/img/projects/copy-api-token.png';
...
<img src={ChannelAddedApiKey} alt="Project Settings Show Channel Api Key" />

### Copy API Key

You can click on the "Copy" button to copy the API key to your clipboard. 

<img src={ChannelCopyApiKey} alt="Project Settings Copy Channel Api Key" />
